...
1. **如果你想学抓包**：学习 [Fiddler 抓包教程](Fiddler抓包教程-软件测试版/)，掌握请求分析
2. **如果你想学接口测试**：学习 [接口测试方法论](../专项测试/接口测试完整教程-软件测试版/)，掌握用例设计
3. **如果你想进入自动化**：学习 [Python 接口自动化](../自动化测试/Python+Requests+Allure接口自动化教程-软件测试版/)，掌握代码化测试
