...
1. **如果你想学 CI/CD**：学习 [Jenkins CI/CD](../持续集成/Jenkins-CICD教程-软件测试版/)，掌握流水线搭建
2. **如果你想做项目实战**：进入 [CI/CD 自动化回归实战](../项目实战/CICD自动化回归实战/)，把自动化接入流水线
3. **如果你想继续学工具**：学习 [Git 版本控制](Git版本控制教程-软件测试版/)，掌握代码协作
