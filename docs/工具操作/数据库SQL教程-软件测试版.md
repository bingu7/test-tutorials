---
description: 数据库 SQL 教程，MySQL 增删改查、多表查询和数据校验。
---
# 数据库 SQL 教程（软件测试人员专用）
...
1. **如果你想巩固 SQL**：做 [SQL 基础测验](SQL基础测验.md)，检验学习效果
2. **如果你想继续学工具**：学习 [Linux 实用教程](Linux实用教程-软件测试版.md)，掌握日志排查
3. **如果你想进入下一阶段**：学习 [Postman 接口测试](Postman接口测试教程-软件测试版.md)，掌握接口调试

### 阶段测验

完成教程后，建议做 [SQL 基础测验](SQL基础测验.md) 检验学习效果。
