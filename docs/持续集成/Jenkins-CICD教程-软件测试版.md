...
1. **如果你想做项目实战**：进入 [CI/CD 自动化回归实战](../项目实战/CICD自动化回归实战.md)，把自动化接入流水线
2. **如果你想巩固容器化**：学习 [Docker 容器](../工具操作/Docker容器教程-软件测试版.md)，掌握环境搭建
3. **如果你想做完整项目**：进入 [项目实战](../项目实战/index.md)，完成完整测试流程
