...
(function() {
    ...
    var QUIZ_REVIEW_MAP = {
        ...
        'bug-tracking': {
            reviewText: '建议回看以下内容：',
            reviewLinks: [
                { url: '/工具操作/禅道与Jira实战教程-软件测试版/', text: '禅道与 Jira 实战教程' },
                { url: '/模板库/缺陷报告模板/', text: '缺陷报告模板' }
            ],
            reviewFocus: '重点关注：缺陷必填要素与标题公式、严重程度与优先级的区别、验证不通过要重新激活而非新建、禅道"缺陷挂产品"的对象模型、解决结果为"设计如此"时回需求确认、重开率与收敛趋势的度量含义、JQL 常用查询',
            passLinks: [
                { url: '/学习中心/第2阶段-工具实战通关/', text: '第 2 阶段工具实战通关检查' },
                { url: '/模板库/测试报告模板/', text: '测试报告模板' }
            ],
            passText: '缺陷管理工具已掌握，建议继续学习：',
            failText: '建议先回看禅道与 Jira 实战教程，重点补缺陷流转闭环与严重程度/优先级的判断。'
        },
        'framework-design': {
            reviewText: '建议回看以下内容：',
            reviewLinks: [
                { url: '/自动化测试/测试框架设计与设计模式教程/', text: '测试框架设计与设计模式教程' },
                { url: '/自动化测试/Python+Requests+Allure接口自动化教程-软件测试版/', text: 'Python 接口自动化教程' }
            ],
            reviewFocus: '重点关注：五层职责边界、断言为何属于用例层、配置隔离与环境变量注入、会话级 Token 复用与 401 续期、统一断言的上下文信息、设计模式对应的真实痛点、测试数据三级分层、重试与并行的前提',
            passLinks: [
                { url: '/项目实战/接口自动化项目实战/', text: '接口自动化项目实战' },
                { url: '/面试专题/自动化测试面试题/', text: '自动化测试面试题' }
            ],
            passText: '框架设计已掌握，建议继续学习：',
            failText: '建议先回看框架设计教程，重点补分层职责划分与可维护性优化。'
        },
        'miniprogram-h5': {
            reviewText: '建议回看以下内容：',
            reviewLinks: [
                { url: '/专项测试/小程序与H5测试教程-软件测试版/', text: '小程序与 H5 测试教程' },
                { url: '/工具操作/Charles抓包教程-软件测试版/', text: 'Charles 抓包教程' }
            ],
            reviewFocus: '重点关注：微信开发者工具面板（尤其 AppData）、onLoad 与 onShow 的差异、页面栈 10 层、wx.login 的 code 三次特性、支付回调幂等、域名白名单与"关闭不校验域名"检查、并发请求上限、真机与模拟器差异、H5 缓存与 JSBridge 兼容',
            passLinks: [
                { url: '/专项测试/移动端专项测试教程-软件测试版/', text: '移动端专项测试教程' },
                { url: '/学习中心/第3阶段-专项测试通关/', text: '第 3 阶段专项测试通关检查' }
            ],
            passText: '小程序与 H5 测试已掌握，建议继续学习：',
            failText: '建议先回看小程序与 H5 测试教程，重点补生命周期与微信生态链路。'
        },
    };
