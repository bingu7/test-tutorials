...
(function() {
    ...
    var relatedMap = {
        ...
        '小程序与H5测试教程': [
            { icon: '📱', title: '移动端专项测试', url: '/专项测试/移动端专项测试教程-软件测试版/' },
            { icon: '🕵️', title: 'Charles 抓包教程', url: '/工具操作/Charles抓包教程-软件测试版/' },
            { icon: '🎪', title: 'Playwright 自动化教程', url: '/自动化测试/Playwright自动化测试教程-软件测试版/' }
        ],
        '禅道与Jira实战教程': [
            { icon: '📋', title: '缺陷报告模板', url: '/模板库/缺陷报告模板/' },
            { icon: '📊', title: '测试报告模板', url: '/模板库/测试报告模板/' },
        ...
        '测试框架设计与设计模式教程': [
            { icon: '🧪', title: 'Python 接口自动化', url: '/自动化测试/Python+Requests+Allure接口自动化教程-软件测试版/' },
            { icon: '🎪', title: 'Playwright 自动化教程', url: '/自动化测试/Playwright自动化测试教程-软件测试版/' },
            { icon: '🔗', title: '接口自动化项目实战', url: '/项目实战/接口自动化项目实战/' }
        ],
        '简历撰写与项目包装': [
            { icon: '🎯', title: '岗位 JD 对照与投递策略', url: '/面试专题/岗位JD对照与投递策略/' },
            { icon: '💬', title: '面试流程与谈薪', url: '/面试专题/面试流程与谈薪/' },
            { icon: '🗣️', title: '项目经验表达', url: '/面试专题/项目经验表达/' }
        ],
        '岗位JD对照与投递策略': [
            { icon: '📄', title: '简历撰写与项目包装', url: '/面试专题/简历撰写与项目包装/' },
            { icon: '💬', title: '面试流程与谈薪', url: '/面试专题/面试流程与谈薪/' },
            { icon: '🔄', title: '面试复盘清单', url: '/面试专题/面试复盘清单/' }
        ],
        '面试流程与谈薪': [
            { icon: '📄', title: '简历撰写与项目包装', url: '/面试专题/简历撰写与项目包装/' },
            { icon: '🎯', title: '岗位 JD 对照与投递策略', url: '/面试专题/岗位JD对照与投递策略/' },
            { icon: '📚', title: '软件测试面试题', url: '/面试专题/软件测试面试题/' }
        ],
        'CICD自动化回归实战': [
            { icon: '🚀', title: 'Jenkins CI/CD', url: '/持续集成/Jenkins-CICD教程-软件测试版/' },
            { icon: '🧪', title: '接口自动化教程', url: '/自动化测试/Python+Requests+Allure接口自动化教程-软件测试版/' },
