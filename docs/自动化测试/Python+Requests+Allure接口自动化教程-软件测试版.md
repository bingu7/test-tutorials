...
1. **如果你想学 Web 自动化**：学习 [Selenium Web 自动化](Selenium-Web自动化教程-软件测试版/)，掌握页面自动化
2. **如果你想学现代自动化**：学习 [Playwright Web 自动化](Playwright自动化测试教程-软件测试版/)，掌握自动等待和网络拦截
3. **如果你想做项目实战**：进入 [接口自动化项目实战](../项目实战/接口自动化项目实战/)，把知识串联起来

### 通关检查

完成本阶段后，使用 [第4阶段-自动化测试通关](../学习中心/第4阶段-自动化测试通关/) 检查是否可以进入下一阶段。
