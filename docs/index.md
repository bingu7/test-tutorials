...
> **55 篇系统化文档**，覆盖从零基础入门到自动化进阶、项目实战、模板案例和面试准备的完整技能栈。
...
<a href="基础理论/测试金字塔与自动化分层策略/">测试金字塔</a>
...
<a href="工具操作/正则表达式教程-软件测试版/">正则表达式</a>
<a href="工具操作/网络知识教程-软件测试版/">网络知识</a>
</td>
<td class="arrow">➡️</td>
<td class="stage s3">
<h3>3️⃣ 自动化进阶</h3>
<p><strong>14+ 天 · 推荐</strong></p>
<p>从手工到自动化</p>
...
<li><a href="基础理论/ISTQB软件测试术语速查/">ISTQB 术语速查</a></li>
<li><a href="基础理论/测试金字塔与自动化分层策略/">测试金字塔</a></li>
<li><a href="基础理论/探索式测试教程-软件测试版/">探索式测试</a></li>
<li><a href="基础理论/Python基础教程-软件测试版/">Python 基础</a></li>
<li><a href="基础理论/前端基础教程-软件测试版/">前端基础</a></li>
<li><a href="基础理论/敏捷测试教程-软件测试版/">敏捷测试</a></li>
...
<li><a href="工具操作/正则表达式教程-软件测试版/">正则表达式</a></li>
<li><a href="工具操作/网络知识教程-软件测试版/">网络知识</a></li>
</ul>
</td>
<td class="tag-card">
<h3>🤖 自动化测试</h3>
...
<p>CI/CD、容器化、性能测试</p>
<ul>
<li><a href="持续集成/Jenkins-CICD教程-软件测试版/">Jenkins CI/CD</a></li>
<li><a href="工具操作/Docker容器教程-软件测试版/">Docker 容器</a></li>
<li><a href="专项测试/JMeter性能测试教程-软件测试版/">JMeter 性能</a></li>
</ul>
</td>
</tr>
<tr>
...
<p>路线、工具选择和阶段自查</p>
<ul>
<li><a href="学习路线/">软件测试学习路线</a></li>
<li><a href="工具选型指南/">工具选型指南</a></li>
<li><a href="阶段学习检查清单/">阶段学习检查清单</a></li>
<li><a href="章节练习与参考答案/">章节练习与参考答案</a></li>
<li><a href="学习验收与通关路径/">学习验收与通关路径</a></li>
</ul>
</td>
<td class="tag-card">
<h3>📋 模板库</h3>
<p>测试文档可以照着写</p>
<ul>
<li><a href="模板库/测试计划模板/">测试计划模板</a></li>
<li><a href="模板库/测试用例模板/">测试用例模板</a></li>
<li><a href="模板库/缺陷报告模板/">缺陷报告模板</a></li>
<li><a href="模板库/测试报告模板/">测试报告模板</a></li>
</ul>
</td>
<td class="tag-card">
<h3>🧪 案例库</h3>
<p>按真实功能练测试思路</p>
<ul>
<li><a href="案例库/登录功能测试案例/">登录功能测试案例</a></li>
<li><a href="案例库/购物车测试案例/">购物车测试案例</a></li>
<li><a href="案例库/下单支付测试案例/">下单支付测试案例</a></li>
<li><a href="案例库/权限控制测试案例/">权限控制测试案例</a></li>
</ul>
</td>
<td class="tag-card">
<h3>🎤 面试专题</h3>
<p>把知识讲成项目经验</p>
<ul>
<li><a href="面试专题/软件测试面试题/">软件测试面试题</a></li>
<li><a href="面试专题/接口测试面试题/">接口测试面试题</a></li>
<li><a href="面试专题/自动化测试面试题/">自动化测试面试题</a></li>
<li><a href="面试专题/项目经验表达/">项目经验表达</a></li>
</ul>
</td>
</tr>
</table>
...
| 基础理论 | 7 | 测试思维、ISTQB 术语、测试金字塔、探索式测试、Python 基础、前端基础、敏捷测试 |
| 工具操作 | 10 | SQL、Redis/MongoDB、Linux、Git、Docker、Fiddler、Postman、接口联调、正则表达式、网络知识 |
...
!!! tip "学习建议"
    ...
    1. **按阶段顺序学习**，不要跳过基础直接学自动化
    2. **边学边练**，学完基础后进入项目实战，把知识串成完整流程
    3. **善用搜索**，右上角搜索框支持全文检索
    4. **收藏常用命令**，把高频命令记到自己的笔记里

!!! warning "注意事项"

    - 教程中的代码示例基于特定版本，实际使用时注意版本兼容
    - 测试纪律：禁止在生产环境执行未授权的操作
    - 敏感信息（密码、Token）不要硬编码，用环境变量管理
